 ...
 * start + pathLength / speed. With starts of 30/60/95 at 2.2 m/s the three
 * arrivals fall around 57s / 89s / 122s — escalating pressure across the round
 * instead of an opening swarm.
 */
export const THIEF = {
