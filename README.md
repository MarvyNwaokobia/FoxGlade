...
`/pet/revive`, plus `POST /event` for the `GameEvents` stamps, each proxied
...
| `SeasonRewards` | n/a | Monthly tournament scoring + native-AVAX prize pool; winner-initiated claims | `0x3C462908c5F1e3a45009f4Ac82dB67Bb95f812DB` |
...
| `GameEvents` | n/a | Cheap on-chain stamp for death / day-complete / day-advanced, no reward, just a permanent record | `0x4459734087282b0F171c6417B19131bFB00cC687` |
